{{> cards/card_component componentName='helparticles' }}

class helparticlesCardComponent extends BaseCard['helparticles'] {
  ...
  dataForRender(profile) {
    ...
    return {
      ...
      feedback: true, // Shows thumbs up/down buttons to provide feedback on the result card
  ...
  static defaultTemplateName (config) {
    return 'cards/helparticles';
  }
}

ANSWERS.registerTemplate(
  'cards/helparticles',
  {{{stringifyPartial (read 'cards/helparticles/template') }}}
);
ANSWERS.registerComponentType(helparticlesCardComponent);